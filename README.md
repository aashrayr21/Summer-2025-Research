...
These four stocks were all picked on the same day in the morning which is why some don't have gains as much as others. I wanted to simulate a trader who would pick a stock for the machine based off of initial stock momentum in the morning. 
